...
Only requiring some minor changes is rulaicoin.cpp.
...
Changes to rulaicoin.cpp
----------------------
rulaicoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
