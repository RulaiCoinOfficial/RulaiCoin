...
This mechanism has been integrated into Bitcore-Node-Rulaicoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rulaicoincoin/insight-api-rulaicoin#web-socket-api](https://github.com/rulaicoincoin/insight-api-rulaicoin#web-socket-api) 
* API: [https://github.com/rulaicoincoin/insight-api-rulaicoin#instantsend-transactions](https://github.com/rulaicoincoin/insight-api-rulaicoin#instantsend-transactions) 
...
By default, the Rulaicoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rulaicoin Core daemon:
