...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Rulaicoin Core rulaicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rulaicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rulaicoin transaction") + "\n" +
              "  rulaicoin-tx [options] -create [commands]   " + _("Create hex-encoded rulaicoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rulaicoin transaction
