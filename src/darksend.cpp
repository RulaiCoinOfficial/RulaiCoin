...
{
    if(fLiteMode) return; // ignore all Rulaicoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Rulaicoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("rulaicoin-privatesend");
