    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rulaicoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rulaicoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rulaicoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Rulaicoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RLA, 0.1 RLA, 1 RLA and 10 RLA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rulaicoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://rulaicoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rulaicoin Core is shutting down...") + "<br /><br />" +
