    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RLA-light"), QVariant("light"));
    ui->theme->addItem(QString("RLA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RLA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RLA-traditional"), QVariant("trad"));
