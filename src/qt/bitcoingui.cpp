    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Rulaicoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rulaicoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rulaicoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Rulaicoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rulaicoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rulaicoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rulaicoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rulaicoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a rulaicoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rulaicoin Core help message to get a list with possible Rulaicoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Rulaicoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rulaicoin network", "", count));
}
...
{
    QString strTitle = tr("Rulaicoin Core"); // default title
    ...
    // Append title to "Rulaicoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
