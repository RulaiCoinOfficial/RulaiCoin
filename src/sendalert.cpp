...
2. run rulaicoind with -printalert or -sendalert like this:
   /path/to/rulaicoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.rulaicoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Rulaicoin Core:0.12.0.58/"));
