...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RulaicoinNetwork") type = RulaicoinNetwork;
    if(strType == "RulaicoinNetworkVariable") type = RulaicoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RulaicoinNetwork) s = "RulaicoinNetwork";
    if(type == RulaicoinNetworkVariable) s = "RulaicoinNetworkVariable";
