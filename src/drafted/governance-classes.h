 ...
 *
 *   // network
 *   CRulaicoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.rulaicoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRulaicoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CRulaicoinNetwork(UniValue objIn)
    {
...
// // can be under: RulaicoinNetwork
// //   -- signature requirements : Key1(User)
// class CRulaicoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == RulaicoinNetwork);
//     // }
